...
<head>
    <meta charset="utf-8">
    <title>Surat Persetujuan Pengajuan KP</title>
    <style>
        body {
...
<body>
    ...
    <div class="nomor-surat">
        <strong>SURAT PERSETUJUAN PENGAJUAN KERJA PRAKTEK</strong><br>
        Nomor: {{ str_pad($pengajuan->id, 3, '0', STR_PAD_LEFT) }}/KP-PGJ/FT/{{ date('Y') }}
    </div>
    ...
    <div class="content">
        ...
        <div class="data-mahasiswa">
            <table class="data">
                ...
                <tr>
                    <td>Jumlah SKS</td>
                    <td>: {{ $mahasiswa->jumlah_sks }} SKS</td>
                </tr>
                <tr>
                    <td>IPK</td>
                    <td>: {{ $mahasiswa->ipk }}</td>
        ...
        <p style="margin-top: 20px;">
            Telah disetujui untuk melaksanakan Kerja Praktek di:
        </p>
        ...
        <div class="data-mahasiswa">
            <table class="data">
                ...
                <tr>
                    <td>Alamat</td>
                    <td>: {{ $pengajuan->city->city_name }}, {{ $pengajuan->province->prov_name }}</td>
                </tr>
            </table>
        </div>
