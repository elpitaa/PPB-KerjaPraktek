...
<head>
    <meta charset="utf-8">
    <title>Surat Persetujuan Proposal KP</title>
    <style>
        body {
...
<body>
    ...
    <div class="nomor-surat">
        <strong>SURAT PERSETUJUAN PROPOSAL KERJA PRAKTEK</strong><br>
        Nomor: {{ str_pad($proposal->id, 3, '0', STR_PAD_LEFT) }}/KP-PRO/FT/{{ date('Y') }}
    </div>
    ...
    <div class="content">
        ...
        <p style="margin-top: 20px;">
            Telah menyusun dan menyerahkan <strong>Proposal Kerja Praktek</strong> yang telah diperiksa dan disetujui untuk dilaksanakan.
        </p>

        <p style="margin-top: 20px;">
            Dengan ini mahasiswa yang bersangkutan diperkenankan untuk melanjutkan ke tahap pelaksanaan Kerja Praktek di perusahaan yang telah ditentukan.
        </p>
