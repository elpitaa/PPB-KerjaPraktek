            ...
            ->schema([
                ...
                Section::make('Data Sidang KP')
                    ->schema([
                        ...
                        Forms\Components\FileUpload::make('file_mahasiswa')
                            ->label('Upload File/Surat Sidang')
                            ->directory('sidang-mahasiswa')
                            ->acceptedFileTypes(['application/pdf', 'application/msword', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'image/jpeg', 'image/png'])
                            ->maxSize(10240)
                            ->helperText('Upload dokumen terkait sidang (PDF, DOC, JPG, PNG - max 10MB)'),
                    ])
                ...
                Components\Section::make('Data Sidang Kp')
                    ->schema([
                        ...
                        Components\TextEntry::make('file_mahasiswa')
                            ...
                            ->default('-')
                            ->formatStateUsing(fn ($state) => $state ? 'File tersedia' : 'Belum upload')
                            ->badge()
