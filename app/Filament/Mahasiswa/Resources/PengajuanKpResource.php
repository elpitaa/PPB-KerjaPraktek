                ...
                Section::make('Data Mahasiswa')
                    ->schema([
                        ...
                        TextInput::make('IPK Mahasiswa')
                            ...
                            ->disabled(),
                        TextInput::make('link_perusahaan')
                            ->label('Link Perusahaan')
                            ->placeholder('https://example.com')
                            ->url()
                            ->default($mahasiswa ? $mahasiswa->link_perusahaan : '')
                            ->helperText('Link website perusahaan tempat KP (opsional)')
                            ->validationMessages([
                                'url' => 'Link harus berupa URL yang valid.',
                            ])
                            ->afterStateUpdated(function ($state) use ($mahasiswa) {
                                if ($mahasiswa) {
                                    $mahasiswa->link_perusahaan = $state;
                                    $mahasiswa->save();
                                }
                            })
                            ->reactive(),
                ...
                Section::make('Data Perusahaan')
                    ->schema([
                        ...
                        static::province_form()
                            ->required()
                            ->helperText('⚠️ Provinsi wajib diisi!'),
                        config('indonesia-territory-forms.forms_visibility.city') ? static::city_form()
                            ->required()
                            ->helperText('⚠️ Kota wajib diisi!') : null,
                        config('indonesia-territory-forms.forms_visibility.district') ? static::district_form()
                            ->required()
                            ->helperText('⚠️ Kecamatan wajib diisi!') : null,
                        config('indonesia-territory-forms.forms_visibility.sub_district') ? static::sub_district_form()
                            ->required()
                            ->helperText('⚠️ Kelurahan wajib diisi!') : null,
